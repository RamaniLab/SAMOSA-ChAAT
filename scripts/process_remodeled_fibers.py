#Now we're going to process all of the remodeled fibers 
...
fho = open('S1_remodeled_leiden_umap.data', 'w')
for density in np.unique(sampleRef['density']):
    if density != 'Negative':
        subSample1 = sampleRef[(sampleRef['seq'] == 'S1') & (sampleRef['density'] == density)]
